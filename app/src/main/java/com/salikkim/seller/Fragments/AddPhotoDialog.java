...
public class AddPhotoDialog extends Dialog implements View.OnClickListener, View.OnTouchListener {
    ...
    public AddPhotoDialog(@NonNull Context activity, boolean set) {
        super(activity);
        this.set = set;
    }
